...
def save_pass(passwords, username):
...
def save_passwords(passwords, username):
...
def add_password(username):
    ...
    user = input("Enter username: ")  # Fixed typo here
    password = input("Enter password: ")
    passwords = load_passwords(username)
    passwords[site] = {"username": user, "password": password}
    save_passwords(passwords, username)  # Changed from user to username
